...
def test_aci_initialization_imperial(aci_imperial_concrete: Concrete_ACI_318_19) -> None:
...
def test_steel_bar_initialization_metric(steel_bar_b500s: SteelBar) -> None:
    ...
    assert_quantity_equal(steel_bar_b500s.epsilon_y, 0.0025 * mm/mm) # Use a dimensionless unit from pint if available, or just float
