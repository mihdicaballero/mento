...
@pytest.fixture()
def beam_example_ehe() -> RectangularConcreteBeam:
...
def test_shear_check_EHE_08(beam_example_ehe: RectangularConcreteBeam) -> None:
...
def test_shear_check_EHE_08_no_rebar_1(beam_example_ehe: RectangularConcreteBeam) -> None:
    f = Forces(V_z=50*kN)
    A_s = 8.04*cm**2
    results = beam_example_ehe.check_shear_EHE_08(f, A_s)  
...
def test_shear_check_EHE_08_no_rebar_2(beam_example_ehe: RectangularConcreteBeam) -> None:
...
def test_shear_check_ACI_318_19(beam_example_imperial: RectangularConcreteBeam) -> None:
...
def test_shear_design_ACI_318_19(beam_example_imperial: RectangularConcreteBeam) -> None:
    f = Forces(V_z=37.727*kip, N_x = 0*kip) 
    A_s = 0.847*inch**2  
